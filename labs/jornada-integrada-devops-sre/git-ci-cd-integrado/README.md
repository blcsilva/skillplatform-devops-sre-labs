# Git, CI/CD e entrega segura
    ...
    Objetivo: conectar mudanca de codigo, pipeline, artefato e rollback.
Conteudo: pull request, workflow, stages, testes, secrets, artefatos e deploy.
Pratica: desenhar uma esteira com gate de qualidade e caminho de reversao.
Criterio de conclusao: justificar como a pipeline reduz risco de producao.
    ...
    Case: aplicacao pratica de "Git, CI/CD e entrega segura".
...
Objetivo pratico: conectar mudanca de codigo, pipeline, artefato e rollback.
...
- workflow: use no case para coletar evidencia, aplicar a pratica ou validar resultado.
