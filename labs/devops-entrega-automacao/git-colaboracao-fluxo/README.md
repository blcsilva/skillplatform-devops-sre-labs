# Git colaborativo e fluxo de mudancas

    Curso: DevOps: automacao, entrega e plataforma

    ## Objetivo

    Objetivo: trabalhar com branches, revisao e rastreabilidade.
Conteudo: commits pequenos, pull requests, tags, releases, merge, rebase e convencoes.
Pratica: simular uma correcao com branch, review e tag de versao.
Criterio de conclusao: explicar como recuperar uma mudanca com baixo risco.
    ...
    Case: aplicacao pratica de "Git colaborativo e fluxo de mudancas".
...
Objetivo pratico: trabalhar com branches, revisao e rastreabilidade.

Ferramentas/conceitos que devem aparecer na resolucao:
- pull request: use no case para coletar evidencia, aplicar a pratica ou validar resultado.
- tag: use no case para coletar evidencia, aplicar a pratica ou validar resultado.
- release: use no case para coletar evidencia, aplicar a pratica ou validar resultado.
- merge: use no case para coletar evidencia, aplicar a pratica ou validar resultado.
- rebase: use no case para coletar evidencia, aplicar a pratica ou validar resultado.
